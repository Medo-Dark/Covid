              ...
              child: Container(
                decoration: BoxDecoration(
                  ...
                  image: DecorationImage(
                    ...
                    fit: BoxFit.cover, // This will fill the background of the container, cropping if necessary
                  ),),
                child: Center(
                    child: Text(
                      'Seeker',
...
class _LocalDataScreenState extends State<LocalDataScreen> {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
        ...
        image: DecorationImage(
        image: AssetImage("assets/images/covid1.jpg"), // Specify your image's path
        fit: BoxFit.cover, // Cover the entire screen with the image
          ),
          ),

      child: Center( // Centers the button in the middle of the screen
        child: ElevatedButton(
          onPressed: () {
            // Call a function to declare "I'm sick"
            declareSickness();
          },
          child: Text("I got infected by covid-19 virus "),
        ),
      ),
    ),
    );
